...
Get-ChocolateyUnzip -FileFullPath "$(Split-Path -Parent $MyInvocation.MyCommand.Definition)\\chatterino7-fortnightly.zip" -Destination "C:\Program Files\Chatterino7" -PackageName "Chatterino7"
